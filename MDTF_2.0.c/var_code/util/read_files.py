...
def read_namelist_envvar(file_input,line,verbose=0):
   ...
   varname = line[1]
   varvalue = line[2]
   if (( verbose > 0 ) and ( len(line) > 3 )): print "WARNING, ignoring line after 3 items ",line
   file_input.namelist.envvar[varname] = varvalue
   os.environ[varname] = varvalue
   if ( verbose > 1 ): print "Added environment variable:  ",varname," = ",varvalue
...
def check_varlist(pod_dir,verbose=0):
   ...
   try:
      ...
      print func_name+" received error:"+str(error) 
